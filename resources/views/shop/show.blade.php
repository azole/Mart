                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-4 ml-auto">
                            <div class="product-section-image" id="productCurrentImage">
                                <img src="{{ asset($product->productImage->first()->original) }}" alt="product" class="active img-fluid"
                                     id="currentImage">
                            </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-sm-4 col-md-4 col-xl-3 col-3">
                                        <div class="product-section-thumbnail selected">
                                            <img src="{{ asset($product->productImage->first()->original) }}" class="img-fluid"
                                                 alt="product">
                                        </div>
                                    </div>
                                    {{-- comment this in production --}}
                                        ...
                                        @foreach ($product->productImage as $image)
                                            <div class="col-sm-4 col-md-4 col-xl-3 col-3 mb-2">
                                                <div class="product-section-thumbnail">
                                                    <img src="{{ asset($image->original) }}" class="w-100"
                                                         alt="product">
                                                </div>
                                            </div>
                                        @endforeach
                                            ...
                                            <div class="col">
                                                    ...
                                                    <form action="{{ route('customerQuestion.store') }}" method="POST">
                                                        ...
                                                        <div class="form-group d-flex">
                                                            <input type="hidden" name="product_id"
                                                                   value="{{ $product->id }}">
                                                            <input type="text" placeholder="Enter your question(s) here"
                                                ...
                                                @guest
                                                    <p class="text-center py-2"><a href="{{ route('login') }}"
                                                                                   class="text-primary">Login</a> or <a
                                                            href="{{ route('register' )}}"
                                                            class="text-primary">Register</a> to ask the seller now</p>
                                                @endguest
                                            </div>
                                        </div>
                                        @if($questions->count())
                                            @foreach($questions as $question)
                                                <div class="row shadow-hover mb-3 py-2 pl-2">
                                                    <div class="col-12 mb-1">
                                                        <div><i class="fas fa-question-circle text-warning"></i> <span
                                                                class="text-gray-700"></span> [{{$question->user->name}}
                                                            ] >> {{$question->question}}
